...
export default function Header() {
    return (
        <>
            <nav className="relative px-4 py-4 flex justify-between items-center bg-theme_green-200">
                <Link className="text-3xl font-bold leading-none" href="/">
                    <svg className="h-10" viewBox="0 0 10240 10240" fill="white">
                ...
                <ul className="hidden absolute top-1/2 left-1/2 transform -translate-y-1/2 -translate-x-1/2 lg:flex lg:mx-auto lg:flex lg:items-center lg:w-auto lg:space-x-6">
                    {nav_link.map((o, index) => (
                        <>
                            <li key={index * 2}><Link className="text-sm text-white hover:text-gray-300" href={o.href}>{o.name}</Link></li>
                            <li className="text-gray-300" key={index * 2 + 1}>
