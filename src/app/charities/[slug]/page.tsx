...
import Rating from "@/components/addons/Rating";
import Tag from "@/components/addons/Tag";
...
function CharityPageImpl(charity: charity) {
    return (
        <>
            <div className="content-center bg-white w-full p-4 pt-8 drop-shadow-md">
                <div className="flex flex-row">
                    <div className="block basis-full">
                        <h1 className="text-6xl font-semibold">{charity.name}
                            {charity.verified &&
                                <span className="inline-block align-top m-3" title="This charity is verified.">
                                    <svg className="h-10" viewBox="0 0 10240 10240" fill="#42A362">
                        ...
                        <h3 className="font-semibold text-lg">Location: {charity.location}</h3>
                    </div>

                    <div className="px-8">
                        {charity.img_href != "/leaf.png" && 
                        <Image className="float-right" src={charity.img_href} alt={`Image of ${charity.name}.`} width="75" height="75"></Image>}
                    </div>
                </div>
            ...
            <div className="flex flex-row content-center">
                <div className="block bg-white w-full p-4 pt-8">
                    ...
                    <br />
                    <h2 className="text-4xl font-semibold mb-2">Verification Status</h2>
                    <p>{charity.verified ? "This charity has been verified." : "This charity has not been verified."}</p>
                </div>
                <div className="basis-1/4">
                    <div className="p-4 bg-gray-100 rounded-md my-9 mr-5 drop-shadow-md text-center">
                        <h2 className="text-2xl font-semibold mb-2 text-center">Tags</h2>
                        <div>
                            {
                                charity.tags.length != 0 ? charity.tags.map((tag_name, index) => (
